...
?>
	...
	<div class='jumbotron text-center' id='homejumbo'>
		<h1>Welcome to Gene Finder!</h1>
		<p>This website can be used to research genes. If you create an account, you can save searches
    ...
    <div class="container choices">
      ...
      <div class="row">
        <div class="col-md-4">
          ...
          <p><a class="btn btn-default" href="http://ec2-52-90-240-175.compute-1.amazonaws.com/learn.php" role="button">Learn</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-md-4">
          ...
          <p><a class="btn btn-default" href="http://ec2-52-90-240-175.compute-1.amazonaws.com/search.php" role="button">Search Page</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-md-4">
          ...
          <p><a class="btn btn-default" href="http://ec2-52-90-240-175.compute-1.amazonaws.com/register.php" role="button">Register an Account</a></p>
        </div><!-- /.col-lg-4 -->
      </div><!-- /.row -->
      ...
      <div class="row featurette">
        <div class="col-md-7">
          <h2 class="featurette-heading">Why care about proteins?<span class="text-muted"><br>They determine everything about you.</span></h2>
